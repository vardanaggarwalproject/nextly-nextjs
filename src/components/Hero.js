              ...
              <CarouselContent className="m-0">
                {heroSlides.map((slide, index) => (
                  <CarouselItem key={slide.id} className="p-0 md:p-0">
                    <HeroSlide slide={slide} isActive={index === currentSlide} t={t} />
                  </CarouselItem>
                ))}
              </CarouselContent>
      ...
      <Container className="py-8 sm:py-10 lg:py-12">
        <div className="flex flex-col justify-center">
          <div className="text-lg sm:text-xl text-center text-gray-700 dark:text-white mb-6 sm:mb-8">
            {t.rich("info", {
              span: (chunks) => (
                <span className="text-cyan-600 dark:text-cyan-400 font-semibold">{chunks}</span>
              ),
            })}
          </div>

          <div className="flex flex-wrap justify-center gap-4 sm:gap-8 md:justify-around">
...
function HeroSlide({ slide, isActive, t }) {
  return (
    <div className={`flex flex-col md:flex-row items-center gap-6 sm:gap-8 lg:gap-12 p-6 sm:p-8 md:p-12`}>
      {/* Text Content */}
      <div className="flex-1 w-full md:w-auto">
        <div className="max-w-x l ">
          <h1 className="text-sm lg:text-2xl xl:text-2xl font-bold leading-snug sm:leading-tight lg:leading-tight tracking-tight text-gray-900 dark:text-white mb-4 sm:mb-6 max-w-full break-words">
            {t(slide.title)}
          </h1>
          <p className="text-xs sm:text-lg lg:text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 max-w-full break-words">
            {t(slide.description)}
          </p>
      ...
      <div className="flex-1 w-full md:w-auto flex items-center justify-center">
        <div className="relative w-full max-w-sm md:max-w-md lg:max-w-lg">
          <div className={`absolute inset-0 bg-gradient-to-br ${slide.gradient} opacity-20 rounded-2xl blur-3xl`}></div>
          <Image
            src={slide.image}
            width="500"
            height="500"
